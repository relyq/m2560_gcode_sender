...
void drawHomeScreen(Adafruit_TFTLCD* tft, Adafruit_GFX_Button* buttonsHome,
  ...
  /*
    buttonsHome[1].initButton(tft, 80, 70, 130, 40, WHITE, BLACK, WHITE,
    "Mover", 3); buttonsHome[1].drawButton();

    buttonsHome[2].initButton(tft, 240, 70, 130, 40, WHITE, BLACK, WHITE,
                              "Config", 3);
    buttonsHome[2].drawButton();

    buttonsHome[5].initButton(tft, 240, 160, 130, 40, WHITE, BLACK, WHITE, "Ir
    0", 3); buttonsHome[5].drawButton();

    buttonsHome[6].initButton(tft, 80, 115, 130, 40, WHITE, BLACK, WHITE,
    "Probe", 3); buttonsHome[6].drawButton();
